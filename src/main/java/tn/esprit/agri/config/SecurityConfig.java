        ...
        public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
                return http
                                ...
                                .authorizeHttpRequests(auth -> auth
                                                .requestMatchers(
                                                                "/", "/index.html", "/sign-contract.html",
                                                                "/payment.html",
                                                                "/payment-success.html", "/payment-cancel.html",
                                                                "/regularize-payment.html",
                                                ...
                                                // Enforce authentication for face enrollment (redundant with
                                                // anyRequest().authenticated() but explicit is better)
                                                .requestMatchers("/agri/auth/**", "/agri/users/**", "/agri/crops/**",
                                                                "/api/payments/**", "/api/solidarity-funds/**")
                                                .permitAll()
